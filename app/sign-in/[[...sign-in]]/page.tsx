    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">ReWear – Login</h1>
          <p className="text-gray-600 dark:text-gray-300">Welcome back to sustainable fashion</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            New to ReWear?{" "}
            <Link href="/sign-up" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium">
              Create an account
            </Link>
          </p>
        </div>
